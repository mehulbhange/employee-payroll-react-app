                    ...
                    <form className="form" action="" onsubmit="save()" onreset="resetForm()">
                        ...
                        <div className="row-content">
                            ...
                            <div className="profile-radio-content">
                                <label>
                                    <input type="radio" name="profile" id="profile1" value="../assets/profile-images/Ellipse -3.png" required />
                                    <img src={profile3} className="profile" alt="" />
                                </label>
                                <label>
                                    <input type="radio" name="profile" id="profile2" value="../assets/profile-images/Ellipse 1.png" required />
                                    <img src={profile1} className="profile" alt="" />
                                </label>
                                <label>
                                    <input type="radio" name="profile" id="profile3" value="../assets/profile-images/Ellipse -8.png" required />
                                    <img src={profile8} className="profile" alt="" />
                                </label>
                                <label>
                                    <input type="radio" name="profile" id="profile4" value="../assets/profile-images/Ellipse -7.png" required />
                        ...
                        <div className="row-content">
                            ...
                            <input type="range" name="salary" id="salary" className="input" min="300000" max="5000000" value="400000" />
                            <output className="salary-output text" htmlFor="salary" id="salaryOutput">400000</output>
                        </div>
                        ...
                        <div className="buttonParent">
                            <a href="./EmployeePayrollHome.html" className="button cancelButton">Cancel</a>
